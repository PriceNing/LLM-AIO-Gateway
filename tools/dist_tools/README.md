...
```
dist/standalone/
├── LLM-AIO-Gateway-windows-x86_64-v0.9.3.zip
├── LLM-AIO-Gateway-macos-arm64-v0.9.3.zip
├── LLM-AIO-Gateway-macos-x86_64-v0.9.3.zip  # 仅在本地选择该目标时生成
├── LLM-AIO-Gateway-linux-x86_64-v0.9.3.tar.gz
├── version.json
...
```json
{
  ...
  "notes": "修复 xxx",
  "artifacts": [
    {"target": "windows", "filename": "LLM-AIO-Gateway-windows-x86_64-v0.9.3.zip",
