...
```
dist/standalone/
├── LLM-AIO-Gateway-windows-x86_64-v0.2.0.zip
├── LLM-AIO-Gateway-macos-arm64-v0.2.0.zip
├── LLM-AIO-Gateway-macos-x86_64-v0.2.0.zip
├── LLM-AIO-Gateway-linux-x86_64-v0.2.0.tar.gz
├── version.json
